      ...
      <div class="info-wrapper">
        <div class="info-about">
          <div class="info-intro">
            <div class="info-intro__subtitle">Contact info</div>
            <div class="info-intro__title">Get in touch</div>
          </div>
          <div class="info-contacts">
            <div class="info-contacts__email">
              <p class="info-contacts__title">Talk to us:</p>
              <p class="info-contacts__text">hello@createx.com</p>
            </div>
            <div class="info-contacts__num">
              <p class="info-contacts__title">Call us:</p>
              <p class="info-contacts__text">(405) 555-0128</p>
            </div>
            <div class="info-contacts__address">
              <p class="info-contacts__title">Address:</p>
              <p class="info-contacts__text">
                2464 Royal Ln. Mesa, New Jersey 45463, USA
              </p>
            </div>
          </div>
          <div class="info-follow">
            <div class="info-follow__title">Follow us:</div>
            <div class="info-follow__wrapper">
              <svg
                width="12"
                height="22"
                viewBox="0 0 12 22"
              ...
              >
                <path
                  d="M8.63262 13.1813L8.2687 18.7653C8.78937 18.7653 9.01488 18.5213 9.2853 18.2283L11.7264 15.6833L16.7847 19.7243C17.7124 20.2883 18.366 19.9913 18.6163 18.7933L21.9365 1.8214L21.9374 1.8204C22.2317 0.324404 21.4415 -0.260593 20.5377 0.106405L1.02135 8.25736C-0.310594 8.82136 -0.290427 9.63136 0.794932 9.99835L5.78447 11.6913L17.3742 3.78039C17.9196 3.38639 18.4155 3.60439 18.0076 3.99839L8.63262 13.1813Z"
                  fill="#787A80"
                />
              </svg>
              <svg
...
.info {
  ...
  &-contacts {
    ...
    &__email {
      ...
      padding-left: 30px;
      &::before {
        content: url("@/assets/img/chat1.svg");
        position: absolute;
        top: 0;
        left: 0;
      }
    ...
    &__num {
      ...
      padding-left: 30px;
      &::before {
        content: url("@/assets/img/iPhone.svg");
        position: absolute;
        top: 0;
        left: 0;
      }

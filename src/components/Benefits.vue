  ...
  <div class="benifits">
    <div class="container">
      <div class="benifits-wrapper">
        <div class="benifits-intro">
          <div class="benifits-intro__subtitle">OUR BENIFITS</div>
          <div class="benifits-intro__title">That’s how we do it</div>
        </div>
        <div class="benifits-buttons">
          <div class="benifits-buttons__btn">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
        ...
        <div class="benifits-about__wrapper">
          <div class="benifits-about">
            <div class="benifits-about__title">Only practicing tutors</div>
            <div class="benifits-about__text">
